'''
06 - A t-SNE map of the stock market
...
The list companies gives the name of each company. PyPlot (plt) has been imported 
for you.
...
- Code to label each point with its company name has been written for you using plt.annotate(), so just hit
  'Submit Answer' to see the visualization!
'''
# Import TSNE
